...
RehabMan=$(BUILDDIR)/SSDT-IGPU.aml $(BUILDDIR)/SSDT-HDEF.aml $(BUILDDIR)/SSDT-HDAU.aml $(BUILDDIR)/SSDT-PNLF.aml $(BUILDDIR)/SSDT-XOSI.aml $(BUILDDIR)/SSDT-XCPM.aml $(BUILDDIR)/SSDT-XHC.aml $(BUILDDIR)/SSDT-DEH01.aml
