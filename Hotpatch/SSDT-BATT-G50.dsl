...
//{
    ...
    External(_SB.PCI0.LPCB.EC.BAT0.OBST, IntObj)
    External(_SB.PCI0.LPCB.EC.BAT0.OBAC, IntObj)
    External(_SB.PCI0.LPCB.EC.BAT0.OBPR, IntObj)
    External(_SB.PCI0.LPCB.EC.BAT0.OBRC, IntObj)
    External(_SB.PCI0.LPCB.EC.BAT0.OBPV, IntObj)
    External(_SB.PCI0.LPCB.EC.B1ST, FieldUnitObj)
    External(_SB.PCI0.LPCB.EC.SMPR, FieldUnitObj)
    External(_SB.PCI0.LPCB.EC.SMST, FieldUnitObj)
    External(_SB.PCI0.LPCB.EC.SMAD, FieldUnitObj)
    External(_SB.PCI0.LPCB.EC.BCNT, FieldUnitObj)
    External(_SB.PCI0.LPCB.EC.SMCM, FieldUnitObj)
    External(_SB.PCI0.LPCB.EC.CMFP, PkgObj)
    External(_SB.PCI0.LPCB.EC.CFMX, MutexObj)
    External(_SB.PCI0.LPCB.EC.FUSL, FieldUnitObj)
    External(_SB.PCI0.LPCB.EC.FUSH, FieldUnitObj)
    External(_SB.PCI0.LPCB.EC.B1CT, FieldUnitObj)
